...
This plugin enables search for your blog without the need for external, server-side, search services.
...
. Add the search index as blog content
+
[source]
...
. Inject the search script to the default template
+
[source]
----
---
...
{#head}
{#search-script /}
//The rest of your default template

----

. Inject the search result overlay and search input to your main page
+
[source]
----
---
...
You can prevent content from being indexed using fontmatter attribute
