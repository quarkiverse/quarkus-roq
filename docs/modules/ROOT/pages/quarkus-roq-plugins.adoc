...
[source,html]
.templates/layouts/roq-default/post-serie.html
----
---
layout: theme-layouts/roq-default/post
---

{#include partials/roq-serie /} //<1>

{#insert /} //<2>

----
<1> This will add the serie partial before the post content, if it's declared.
<2> This is the post content

And finally, use this layout and add the `serie` attribute in the Front Matter of the posts you want to join.
...
author: John Doe
serie: My Serie Title // <1>
---
----

<1> You should use the exact same title for all documents in the serie.