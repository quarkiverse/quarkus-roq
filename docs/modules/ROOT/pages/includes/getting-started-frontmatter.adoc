...
You can also prepare partial templates. They are located by default in `site/_includes/`. For example:
...
Your site index template is required and should be located in `site/index.html`.
