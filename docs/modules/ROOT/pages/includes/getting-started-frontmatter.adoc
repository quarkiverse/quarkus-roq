...
// https://excalidraw.com/#json=iDMNJoYdZ-_57mVkcHRWl,bwhI0ERmsEaDs5H1g4sfSQ
...
NOTE: if you don't already have layouts and partials in your project, add the default Roq theme or create your own templates (https://github.com/quarkiverse/quarkus-roq/tree/main/theme/default/src/main/resources/site[example templates].
...
----
<1> This time we use the `templates/layouts/post.html` layout.
