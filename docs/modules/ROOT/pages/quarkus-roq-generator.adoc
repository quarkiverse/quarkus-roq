...
Use static selection when you have want to include a **fixed set of extra paths** that don't change based on external data.
...
<3> Generate a static HTML page for each post: `/blog/hello-world/index.html`, etc.
