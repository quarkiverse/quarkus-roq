...
a|icon:lock[title=Fixed at build time] [[quarkus-roq-frontmatter_site-collections-collections-map-generate]] [.property-path]##link:#quarkus-roq-frontmatter_site-collections-collections-map-generate[`+++site.collections."collections-map".generate+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++site.collections."collections-map".generate+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_COLLECTIONS__COLLECTIONS_MAP__GENERATE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_COLLECTIONS__COLLECTIONS_MAP__GENERATE+++`
endif::add-copy-button-to-env-var[]
--
|boolean
