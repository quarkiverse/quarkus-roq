...
a|icon:lock[title=Fixed at build time] [[quarkus-roq-frontmatter_site-collections-collections-map-generate-from-data]] [.property-path]##link:#quarkus-roq-frontmatter_site-collections-collections-map-generate-from-data[`+++site.collections."collections-map".generate-from-data+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++site.collections."collections-map".generate-from-data+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_COLLECTIONS__COLLECTIONS_MAP__GENERATE_FROM_DATA+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_COLLECTIONS__COLLECTIONS_MAP__GENERATE_FROM_DATA+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-roq-frontmatter_site-collections-collections-map-title-attribute-name]] [.property-path]##link:#quarkus-roq-frontmatter_site-collections-collections-map-title-attribute-name[`+++site.collections."collections-map".title-attribute-name+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++site.collections."collections-map".title-attribute-name+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_COLLECTIONS__COLLECTIONS_MAP__TITLE_ATTRIBUTE_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_COLLECTIONS__COLLECTIONS_MAP__TITLE_ATTRIBUTE_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|
