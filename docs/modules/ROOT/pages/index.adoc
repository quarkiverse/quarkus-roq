...
The documentation is available in the https://iamroq.dev/docs/[Roq website].
...
* xref:quarkus-roq-plugin-og-image.adoc[*Roq OG Image*]: Generate Open Graph social preview PNGs from Qute SVG templates and inject `og:image` SEO metadata.
