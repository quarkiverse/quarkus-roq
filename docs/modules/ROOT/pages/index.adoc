...
If you want to use this extension, you need to add the `io.quarkiverse.statiq:quarkus-statiq` extension first to your build file.
...
include::includes/quarkus-statiq.adoc[leveloffset=+1, opts=optional]
