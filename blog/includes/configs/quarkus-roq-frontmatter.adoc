...
[.description]
--
The layout to use for normal html pages if not specified in FM. When empty, the page will not use a layout when it doesn't specify it in FM.
...
a|icon:lock[title=Fixed at build time] [[quarkus-roq-frontmatter_site-default-locale]] [.property-path]##link:#quarkus-roq-frontmatter_site-default-locale[`+++site.default-locale+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++site.default-locale+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_DEFAULT_LOCALE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_DEFAULT_LOCALE+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++en+++`
...
[.description]
--
Indicates whether file names in the public directory and files attached to pages should be slugified (converted to a URL-friendly format).

When enabled, file names will automatically be transformed into a URL-safe format. Additionally, `page.file` and `site.file` references can use the original file names, as they will also be slugified during the process.
...
a|icon:lock[title=Fixed at build time] [[quarkus-roq-frontmatter_site-collections-collections-map-enabled]] [.property-path]##link:#quarkus-roq-frontmatter_site-collections-collections-map-enabled[`+++site.collections."collections-map".enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++site.collections."collections-map".enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_COLLECTIONS__COLLECTIONS_MAP__ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_COLLECTIONS__COLLECTIONS_MAP__ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
[.description]
--
The layout to use if not specified in FM data. When empty, the document will not use a layout when it doesn't specify it in FM.
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_COLLECTIONS__COLLECTIONS_MAP__FROM_DATA_ID_KEY+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_COLLECTIONS__COLLECTIONS_MAP__FROM_DATA_ID_KEY+++`
endif::add-copy-button-to-env-var[]
--
|string
|required icon:exclamation-circle[title=Configuration property is required]

a|icon:lock[title=Fixed at build time] [[quarkus-roq-frontmatter_site-collections-collections-map-from-data-name]] [.property-path]##link:#quarkus-roq-frontmatter_site-collections-collections-map-from-data-name[`+++site.collections."collections-map".from-data.name+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++site.collections."collections-map".from-data.name+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++SITE_COLLECTIONS__COLLECTIONS_MAP__FROM_DATA_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++SITE_COLLECTIONS__COLLECTIONS_MAP__FROM_DATA_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|
