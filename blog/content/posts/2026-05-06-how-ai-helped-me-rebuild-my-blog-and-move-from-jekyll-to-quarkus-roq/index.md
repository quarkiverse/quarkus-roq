...
![old-blog-design.png](old-blog-design.webp)
...
![tennis-club-article.png](tennis-club-article.webp)
...
![design-iteration-1.png](design-iteration-1.webp)

![design-iteration-2.png](design-iteration-2.webp)
...
![design-street-art.png](design-street-art.webp)
...
![design-inspiration-found.png](design-inspiration-found.webp)
...
![hero-attempt-1.png](hero-attempt-1.webp)
...
> ![hero-reference-style.png](hero-reference-style.webp)
...
![hero-attempt-2-no-glasses.png](hero-attempt-2-no-glasses.webp)
...
![hero-final-with-glasses.png](hero-final-with-glasses.webp)
...
![website-skeleton-mockup.png](website-skeleton-mockup.webp)
...
![hero-transparent-background-fail.png](hero-transparent-background-fail.webp)
...
![hero-gimp-extracted.png](hero-gimp-extracted.webp)
...
![github-issue-redesign.png](github-issue-redesign.webp)
...
![homepage-no-excerpt.png](homepage-no-excerpt.webp)
*After migrating to Roq, the homepage list only displays metadata (title, tags, date) and a "read more" button, the excerpt is missing.*
 ...
 ![homepage-with-excerpt.png](homepage-with-excerpt.webp)
...
And there it was:
![tailwind-cdn-warning.png](tailwind-cdn-warning.webp)
```
...
![dark-mode-broken.png](dark-mode-broken.webp)
...
![debugging-tailwind-version-1.png](debugging-tailwind-version-1.webp)


![debugging-tailwind-version-2.png](debugging-tailwind-version-2.webp)
...
![debugging-tailwind-version-3.png](debugging-tailwind-version-3.webp)
...
![dark-mode-fixed.png](dark-mode-fixed.webp)
...
![old-url-404.png](old-url-404.webp)
