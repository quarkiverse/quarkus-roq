...
Roq provides built-in support for social media links with icons. You can easily add social media links to your site.

=== Configuration

To add social brands to your site, create or edit the page file:
...
These social links are typically rendered by themes in headers, footers, or author sections. Each theme may display them differently.

=== Available Social Brands

The following social platforms are supported out of the box:

[cols="2,3,3"]
|===
|Social Brand |Configuration Key |Link Format
...
|`https://in.linkedin.com/company/companyname`
...
|Mastodon
|`social-mastodon`
|Full URL required (e.g., `https://mastodon.social/@username`)

|Slack
|`social-slack`
|Full URL required (e.g., `https://yourworkspace.slack.com` or invite link)
