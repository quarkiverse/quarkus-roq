...
To add a Table of Content, use the `page-content-toc` attribute in your AsciiDoc header:
...
. Inject the search resultverlay in the `<body>` and search button in the navigation. For example with the default theme:
+
