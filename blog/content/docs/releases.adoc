...
* Custom plugins consuming `RoqFrontMatterRawTemplateBuildItem` or `RoqFrontMatterScanProcessor` must be updated — these are replaced by the new step-based build items.
