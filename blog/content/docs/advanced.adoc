...
| All
| `:name`
| The slugified name of the file. If the filename contains a date (e.g., '2025-08-21-My-Blog-Post.md'), the date portion will be stripped away. This behavior mimics that found in Jekyll builds, making any migrations simpler.
| `my-blog-post`

| All
| `:Name`
| The case-preserving slugified name of the file. If the filename contains a date (e.g., '2025-08-21-My-Blog-Post.md'), the date portion will be stripped away. This behavior mimics that found in Jekyll builds, making any migrations simpler.
| `My-Blog-Post`
