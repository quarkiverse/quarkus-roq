...
At build time, Roq generates `/llms.txt` and `/llms-full.txt` following the https://llmstxt.org/[llms.txt specification]. AI systems like ChatGPT, Claude, and Perplexity use these files to understand site structure and content.
...
> A blog about Quarkus and web development

## Posts

- [Getting Started with Roq](/posts/getting-started): Learn how to create your first Roq site
- [Theming Guide](/posts/theming): Customize your site with themes and Tailwind CSS

## Pages

- [About](/about): About the author and this site
----

Both files are enabled by default. To disable generation, add the following to your configuration:
...
To customize the output, create your own `content/llms.txt` or `content/llms-full.txt`. Roq uses your file instead of generating one. You can start from the built-in template:
