...
description: We introduced a way to use a alias for making it easy to redirect to your blog post!
author: mcruzdev
...
- [aliases-very-cool]({site.rootUrl.resolve('/aliases-very-cool')})
- [aliases-4-ever]({site.rootUrl.resolve('/aliases-4-ever')})
- [aliases-again]({site.rootUrl.resolve('/aliases-again')})
