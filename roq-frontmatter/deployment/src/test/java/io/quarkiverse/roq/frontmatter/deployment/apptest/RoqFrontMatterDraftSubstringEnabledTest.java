...
public class RoqFrontMatterDraftSubstringEnabledTest {
    ...
    @Test
    @DisplayName("Post in drafts/ directory is visible when drafts are enabled")
    ...
    @Test
    @DisplayName("Post in mydrafts/ directory is not draft (substring must not match)")
    public void testMydraftsSubstringPostNotDraft() {
