...
public class RoqFrontMatterLayoutScanProcessor {
    ...
    @BuildStep
    void declareAndScanTemplatesDir(RoqProjectBuildItem roqProject,
    ...
    void scanLayouts(RoqProjectBuildItem roqProject,
        ...
        for (ProjectFile file : layoutFiles) {
            ...
            final String siteDirPath = deriveSiteDirPath(file.path(), fullRelativePath);
        ...
        // Query roqResourceDir/templates for non-root theme layout resources
        if (!roqProject.isRoqResourcesInRoot()) {
