...
include::_includes/hello.adoc[]

## Lvel Offset

include::_includes/special.adoc[leveloffset=+2"]


## Lines

include::_includes/special.adoc[leveloffset=+2,lines="1..2,15..20"]

## Tags:

include::_includes/tags.adoc[tags=snippets]

include::_includes/tags.adoc[tags=snippet-a]