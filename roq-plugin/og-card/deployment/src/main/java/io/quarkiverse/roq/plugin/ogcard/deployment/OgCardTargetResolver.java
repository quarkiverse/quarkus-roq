...
final class OgCardTargetResolver {

    private OgCardTargetResolver() {
    }

    record ResolvedTargets(Map<String, OgCardTarget> byRelativePath, Map<String, OgCardTarget> byPngPath) {
    }
    ...
    static ResolvedTargets resolve(
        ...
        Map<String, OgCardTarget> byRelativePath = new LinkedHashMap<>();
        Map<String, OgCardTarget> byPngPath = new LinkedHashMap<>();
    ...
    static OgCardTarget targetFromSource(OgCardConfig config, SourceData source, String pagePath, String collectionId,
        ...
        if (collectionId != null && isExcluded(config, pagePath)) {
            return null;
        }
    ...
    static boolean matchesSource(OgCardConfig config, SourceData source, String pagePath, String collectionId,
            boolean siteIndex) {
        if (!source.isPage()) {
            return false;
        }
    ...
    private static boolean shouldIncludeNormalPage(OgCardConfig config, String resourcePath, boolean siteIndex,
    ...
    private static boolean isExcluded(OgCardConfig config, String resourcePath) {
        String normalizedResource = prefixWithSlash(resourcePath);
        for (String exclude : config.excludePaths().orElse(List.of())) {
    ...
    private static void addTarget(
            OgCardConfig config,
            String siteName,
            Map<String, OgCardTarget> byRelativePath,
            Map<String, OgCardTarget> byPngPath,
            String sourcePath,
            String pagePath,
            String collectionId,
            String slug,
        ...
        OgCardTarget target = new OgCardTarget(
                pngPath,
                sourcePath,
                truncate(title, 120),
                truncate(description, 200),
    ...
    static String pngPath(OgCardConfig config, String pagePath, String collectionId, String slug) {
    ...
    private static String collectionOutputSegment(OgCardConfig config, String collectionId) {
